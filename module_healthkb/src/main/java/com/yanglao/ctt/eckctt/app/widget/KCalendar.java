 ...
 * 
 * @author huangyin
 * testselectcolor  #4fd0d7  #ffe74c3c
 */
...
public class KCalendar
	...
	public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#ffe74c3c"); // 星期标题文字颜色
	...
	public static final int COLOR_BG_THIS_DAY = Color.parseColor("#ff4fd0d7"); // 当天日历背景颜色
				...
				if (i == 0 && j == 0 && weekday != 0) {
					...
					if (day <= lastDay) {
						...
						if (dayBgColorMap.get(dates[i][j]) != null) {
							...
							view.setBackgroundColor(Color.parseColor("#7db9f5"));
							/*view.setBackgroundResource(dayBgColorMap
									.get(dates[i][j]));*/
						}
						// 设置标记
